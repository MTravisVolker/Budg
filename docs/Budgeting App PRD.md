...
There are many budgeting apps already but none with the simplicity and methodology as this budgeting app. This budgeting app is almost more of a checkbook register than a budgeting app. Every feature that can be removed from the budgeting process has been deleted. And every feature that can be made easier and more user-friendly has been perfectly optimized.
...
- In-Scope:
  ...
  - User authentication
    ...
    - API Auth Tokens
  - Automations:
    - Add calculated next Due Bill based on recurrence and last Due Bill Due Date
  - Optimized and Modern UI:
    - Tables are beautifully and simply designed
    - Modal Popups are used
    - Every feature is exactly where you want it
    - Table rows are drag and dropable
- Out-of-Scope
...
10. **Drag And Drop Reprioritization**:
   - The rows in the table can be reprioritized by dragging and dropping them.
